...
public final class DashboardFixtures {
  ...
  private static final List<KpiSeed> KPIS =
      List.of(
          new KpiSeed("Zdarzeń ostatnia minuta", "847", "+12,4% vs śr.", "up", 60, 0.4),
          new KpiSeed("Aktywne sesje", "312", "+4,1%", "up", 30, 0.3),
          new KpiSeed("Maile dostarczone (24h)", Format.number(8410), "−2,0%", "down", 90, 0.25),
          new KpiSeed("Przypisany przychód (24h)", Format.money(94200), "+22,4%", "up", 100, 0.5));

  private static final List<Legend> LEGEND =
      List.of(
  ...
  public static List<KpiSeed> kpis() {
    return KPIS;
  }

  public static List<Legend> legend() {
    return LEGEND;
  }
}
