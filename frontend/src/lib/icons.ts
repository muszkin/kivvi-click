/**
 * Inline stroke icon paths, ported 1:1 from src/Twig/IconExtension.php's ICONS map — the
 * single source of truth for iconography: 24x24 viewBox, stroke-width 1.7, round caps and
 * joins. Add icons here, never inline an SVG in a component.
 */
