 ...
 *
 * A translation of the Polish text, which is the authoritative version — keep the two in step.
 * See privacy.pl.ts for where the controller's details came from, which two sections are pinned
 * to what the code actually does, and why the catalogue lives under `privacyPage` rather than
 * `privacy`.
 */
export default {
    privacyPage: {
        ...
        sections: [
            {
                ...
                body: "The controller of your data is Fairydeck Piotr Mucha, a sole proprietorship registered at ul. Topolowa 16U, 32-005 Niepołomice, Poland, tax ID (NIP) 7321962870. For anything concerning personal data: piotr{'@'}kivvi.click.",
            },
            {
                heading: "Data protection officer",
                body: "We have not appointed a data protection officer — at this scale and kind of processing we are not required to. Send anything concerning your data straight to piotr{'@'}kivvi.click.",
            },
            {
            ...
            },
            {
                ...
                body: "On your consent — Article 6(1)(a) GDPR.",
            },
            {
            ...
            },
            {
                ...
                body: "You have the right to withdraw your consent at any time — Article 7(3) GDPR. Write to piotr{'@'}kivvi.click and we will remove your address from the list. Withdrawing is as easy as consenting was, and it does not affect the lawfulness of what we did before you withdrew it.",
            },
            {
                heading: "Your rights",
                body: "You have the right to access your data, to have it corrected or erased, to restrict its processing, to have it ported, and to withdraw your consent at any time. To exercise any of them, write to piotr{'@'}kivvi.click. You also have the right to lodge a complaint with the President of the Personal Data Protection Office (ul. Stawki 2, 00-193 Warsaw, Poland) if you believe we are processing your data unlawfully.",
            },
            {
            ...
            },
            {
                ...
                body: "The landing page and this policy set no cookies and use no analytics or tracking tools. A session cookie is created only once you sign in to the panel, which is not publicly available yet.",
            },
            {
            ...
            {
                heading: "Contact",
                body: "For anything concerning personal data: piotr{'@'}kivvi.click. We answer within one month of receiving your message at the latest.",
            },
            {
