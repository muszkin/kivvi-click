...
| `context/plans/2026-09-08-symfony-to-spring-vue-migration.md` | migration-planning skill | plan (approved) | approved 2026-09-08, sha256 `33af3600ac7e933b…` | implementation-orchestrator (migration profile) after approval |
| `context/migration-oracle/symfony-to-spring-vue/` (manifest, inventory, 13 journeys, behaviours, rules, performance, capture tooling) | migration-planning skill | canonical evidence (immutable oracle) | captured 2026-09-08 on `5b806ac`, manifest sha256 `4945a8deb19ea342…` | implementation-orchestrator verifier cohort; never edited, only recaptured by migration-planning |
