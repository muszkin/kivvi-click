...
Read `../../common-journey-rules.md` first. **Worktree:** /home/muszkin/work/kivvi-click-wt/w3-settings · branch `migration/wave-3/settings` · parent SHA <PARENT-SHA>. **Lease:** compose project `kivvi-w-settings`, HTTP_PORT=19070, HTTPS_PORT=19071. **Model:** sonnet, effort HIGH.
