...
Read `../../common-journey-rules.md` first. **Worktree:** /home/muszkin/work/kivvi-click-wt/w1-scheduler-heartbeat · branch `migration/wave-1/scheduler-heartbeat` · parent SHA 887af4543c5a51255735f1ddfc0d8860d11551c0. **Lease:** compose project `kivvi-w-heartbeat`, HTTP_PORT=19030, HTTPS_PORT=19031. **Model:** sonnet, effort HIGH.
