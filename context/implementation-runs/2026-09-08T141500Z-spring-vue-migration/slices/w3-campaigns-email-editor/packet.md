...
Read `../../common-journey-rules.md` first. **Worktree:** /home/muszkin/work/kivvi-click-wt/w3-campaigns-email-editor · branch `migration/wave-3/campaigns-email-editor` · parent SHA <PARENT-SHA>. **Lease:** compose project `kivvi-w-campaigns`, HTTP_PORT=19080, HTTPS_PORT=19081. **Model:** sonnet, effort HIGH.
