...
Read `../../common-journey-rules.md` first. **Worktree:** /home/muszkin/work/kivvi-click-wt/w1-feeds · branch `migration/wave-1/feeds` · parent SHA 887af4543c5a51255735f1ddfc0d8860d11551c0. **Lease:** compose project `kivvi-w-feeds`, HTTP_PORT=19020, HTTPS_PORT=19021. **Model:** sonnet, effort HIGH.
