...
Read `../../common-journey-rules.md` first. **Worktree:** /home/muszkin/work/kivvi-click-wt/w3-automations · branch `migration/wave-3/automations` · parent SHA b87a701244f5316e1a53bace7a1e41facdffc277 (feature HEAD after wave-2). **Lease:** compose project `kivvi-w-automations`, HTTP_PORT=19060, HTTPS_PORT=19061. **Model:** sonnet, effort HIGH.
