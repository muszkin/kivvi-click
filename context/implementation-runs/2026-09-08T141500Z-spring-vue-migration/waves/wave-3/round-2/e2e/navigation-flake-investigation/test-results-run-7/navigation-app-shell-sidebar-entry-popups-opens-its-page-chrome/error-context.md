...
- Name: navigation.spec.ts >> app shell >> sidebar entry "popups" opens its page
...
Expected substring: "Popupy i widgety"
Timeout: 5000ms
...
- main:
  ...
  - navigation "Ścieżka": aureashop.pl / Popupy i widgety
