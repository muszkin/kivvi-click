...
- Name: navigation.spec.ts >> app shell >> theme toggle survives a reload
- Location: specs/navigation.spec.ts:89:9
...
Call log:
  ...
  - waiting for locator('html')
    14 × locator resolved to <html lang="pl" data-theme="light" data-sidebar="expanded">…</html>
